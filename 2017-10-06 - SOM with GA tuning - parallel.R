# TODO - MAKE INITIAL SAMPLE RUN PROPERLY RATHER THAN JUST TAKING FIRST FEW AT RANDOM. PROBABLY SHOULD RE-FACTOR THE CODE
...
player_df <- sample_n(player_df,5000)
#######################################################
...
for (k in (1: iterations)){
  ...
  write.xlsx(results,file="SOM_tuning_results_dynamic.xlsx") #keep results in case of crash
